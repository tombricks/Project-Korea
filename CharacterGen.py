...
characters = [
	{
		...
		"name": "Tino Chrupalla",
		"leaders": {
			"Western_Outlook": [ "TITLE_Chancellor", "IDEOLOGY_Right_Wing_populism" ]
		},
		"advisors": {
		}
	}
...
for character in characters:
	...
	if output:
		with open("localisation/english/Country_"+character["tag"]+"_l_english.yml", "a", encoding="utf8") as file:
			file.write('\n\n'+charactersLocalisation)
